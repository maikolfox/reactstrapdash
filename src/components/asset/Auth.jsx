...
const Auth = 
{
    username:"dXNlcm5hbWUy",//username in base 64
    displayname:"ZGlzcGxheW5hbWUy",// Display name in base 64
...
//    }
       ...
       getAuthAdmin(profileTab)
       {    
        return this.canAccessToThisPage(this.authAdmin,profileTab);
       },
       getAuthUser(profileTab)
       {    
         return this.canAccessToThisPage(this.authUser,profileTab);
       }
