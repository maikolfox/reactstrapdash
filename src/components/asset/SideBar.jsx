...
const navObj= props.match.url!==undefined ? <NavLink exact activeClassName="activeNav" to={`${props.match.url}/${props.menuItem.url}`}>{props.menuItem.libelle}</NavLink> :
<NavLink exact activeClassName="activeNav" to={`${props.match}/${props.menuItem.url}`}>{props.menuItem.libelle}</NavLink> 
    return (
        navObj    )
}
